...
const typeConfig: Record<string, { bg: string; border: string; icon: string; glow: string }> = {
  success: {
    bg: "linear-gradient(135deg, rgba(49,162,76,0.12), rgba(49,162,76,0.04))",
    border: "rgba(49,162,76,0.3)",
    icon: "M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    glow: "0 0 20px rgba(49,162,76,0.15)",
  },
  error: {
    bg: "linear-gradient(135deg, rgba(228,30,63,0.12), rgba(228,30,63,0.04))",
    border: "rgba(228,30,63,0.3)",
    icon: "M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z",
    glow: "0 0 20px rgba(228,30,63,0.15)",
  },
  info: {
    bg: "linear-gradient(135deg, rgba(194,113,21,0.12), rgba(194,113,21,0.04))",
    border: "rgba(194,113,21,0.3)",
    icon: "M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z",
    glow: "0 0 20px rgba(194,113,21,0.15)",
  },
};
